...
const FEATURE_LIB=[
 ...
 {n:'Combat Superiority',g:'Fighter — Battle Master',l:3,d:'Learn 3 maneuvers (2 more at 7th, 10th & 15th — 7 total) and gain 4 superiority dice, d8s (5 at 7th, 6 at 15th). Spend a die to fuel a maneuver on a hit or as a reaction; regain all expended dice on a short/long rest. Maneuver save DC = 8 + proficiency + STR/DEX mod.',combat:true},
 ...
 // feature, not per maneuver. Not a choice yet at 3rd level in this app: add the ones you pick.
 {n:'Commander\'s Strike',g:'Fighter — Battle Master',l:3,d:'Bonus action: forgo one of your attacks to direct a willing ally to use their reaction to attack the same target; add the superiority die to their damage.',combat:true,actionType:'bonus'},
 {n:'Disarming Attack',g:'Fighter — Battle Master',l:3,d:'On a hit, add the superiority die to the damage; target makes a STR save or drops one item of your choice it\'s holding.',combat:true},
 {n:'Distracting Strike',g:'Fighter — Battle Master',l:3,d:'On a hit, add the superiority die to the damage; the next attack against that creature by someone other than you has advantage before your next turn.',combat:true},
 {n:'Evasive Footwork',g:'Fighter — Battle Master',l:3,d:'While you move, add the superiority die to your AC until you stop moving.',combat:true},
 {n:'Feinting Attack',g:'Fighter — Battle Master',l:3,d:'Bonus action to feint against a creature within 5 ft.; advantage on your next attack against it this turn, and add the superiority die to the damage on a hit.',combat:true,actionType:'bonus'},
 {n:'Goading Attack',g:'Fighter — Battle Master',l:3,d:'On a hit, add the superiority die to the damage; target makes a WIS save or has disadvantage on attacks against anyone but you until your next turn.',combat:true},
 {n:'Lunging Attack',g:'Fighter — Battle Master',l:3,d:'When you make a melee attack, increase your reach by 5 ft. for it; add the superiority die to the damage on a hit.',combat:true},
 {n:'Maneuvering Attack',g:'Fighter — Battle Master',l:3,d:'On a hit, add the superiority die to the damage; a willing ally can then use their reaction to move up to half their speed without provoking opportunity attacks from the target.',combat:true},
 {n:'Menacing Attack',g:'Fighter — Battle Master',l:3,d:'On a hit, add the superiority die to the damage; target makes a WIS save or is frightened of you until the end of your next turn.',combat:true},
 {n:'Parry',g:'Fighter — Battle Master',l:3,d:'Reaction when hit by a melee attack: reduce the damage by the superiority die roll + your DEX modifier.',combat:true,actionType:'reaction'},
 {n:'Precision Attack',g:'Fighter — Battle Master',l:3,d:'When you make an attack roll, add the superiority die to it, before or after seeing the roll.',combat:true},
 {n:'Pushing Attack',g:'Fighter — Battle Master',l:3,d:'On a hit, add the superiority die to the damage; target makes a STR save or is pushed 15 ft. away, if Large or smaller.',combat:true},
 {n:'Rally',g:'Fighter — Battle Master',l:3,d:'Bonus action: choose a friendly creature that can see or hear you; it gains temporary HP equal to the superiority die roll + your CHA modifier.',combat:true,actionType:'bonus'},
 {n:'Riposte',g:'Fighter — Battle Master',l:3,d:'Reaction when a creature misses you with a melee attack: make a melee attack against it; add the superiority die to the damage on a hit.',combat:true,actionType:'reaction'},
 {n:'Sweeping Attack',g:'Fighter — Battle Master',l:3,d:'On a hit, choose another creature within 5 ft. of the original target and within your reach; it takes damage equal to the superiority die roll if the attack would\'ve hit its AC.',combat:true},
 {n:'Trip Attack',g:'Fighter — Battle Master',l:3,d:'On a hit, add the superiority die to the damage; target makes a STR save or is knocked prone, if Large or smaller.',combat:true},
 // Fighter: Samurai
